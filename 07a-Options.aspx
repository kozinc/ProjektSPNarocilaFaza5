<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="07a-Options.aspx.cs" Inherits="Options" %>
...
<body>
    ...
    <div>
       ...
       <br />
       <asp:HyperLink ID="languageLink" runat="server" NavigateUrl="~/07a-Options.aspx" 
          Visible="False">Click here to choose another language</asp:HyperLink>
       <br />
       <asp:HyperLink ID="recommendationsLink" runat="server" 
          NavigateUrl="~/07b-Recommendations.aspx" Visible="False">Click here to get book recommendations</asp:HyperLink>
    </div>
    </form>
</body>
</html>
